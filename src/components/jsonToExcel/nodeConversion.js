...
const methodology = require("../data/nodeMethodology");
...
const report = excel.buildExport([
  ...
  {
    name: "Methodology", // <- Specify sheet name (optional)
    merges: merges, // <- Merge cell ranges
    specification: methodology.methodologySpecification, // <- Report specification
    data: methodology.methodologyData, // <-- Report data
  },
  {
    name: "Fugitive Emission", // <- Specify sheet name (optional)
